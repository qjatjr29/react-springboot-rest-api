...
public class CombinationPizza implements Food {
    ...
    public CombinationPizza(UUID foodId, String name, Integer price, String category, String description, String subCategory, String image, UUID storeId) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
    ...
    public CombinationPizza(UUID foodId, String name, Integer price, String description, String image, UUID storeId) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
        this.description = description;
        ...
        subCategory = PizzaType.COMBINATION.getType();
    }
