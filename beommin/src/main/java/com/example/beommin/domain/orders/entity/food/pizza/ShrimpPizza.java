...
public class ShrimpPizza implements Food {
    ...
    public ShrimpPizza(UUID foodId, String name, Integer price, String category, String description, String subCategory, String image, UUID storeId) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
    ...
    public ShrimpPizza(UUID foodId, String name, Integer price, String description, String image, UUID storeId) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
        this.description = description;
        ...
        subCategory = PizzaType.SHRIMP.getType();
    }
    @Override
