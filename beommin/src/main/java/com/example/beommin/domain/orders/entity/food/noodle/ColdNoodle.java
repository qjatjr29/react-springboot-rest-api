...
public class ColdNoodle implements Food {
    ...
    public ColdNoodle(UUID foodId, String name, Integer price, String description, String image, UUID storeId) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
        ...
        subCategory = NoodleType.COLD_NOODLE.getType();
    }
