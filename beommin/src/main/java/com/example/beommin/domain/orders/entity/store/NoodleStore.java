...
public class NoodleStore implements Store{
    ...
    public NoodleStore(UUID storeId, String name, String address, String phoneNumber, StoreCategory category, String image, LocalDate createdAt) {
