...
public class FrenchFries implements Food {
    ...
    public FrenchFries(UUID foodId, String name, Integer price, String description, String image, UUID storeId) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
        ...
        subCategory = HamburgerType.FRENCHFRIES.getType();
    }
