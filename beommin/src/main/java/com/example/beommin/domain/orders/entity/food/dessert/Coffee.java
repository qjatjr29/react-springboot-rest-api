...
public class Coffee implements Food  {
    ...
    public Coffee(UUID foodId, String name, Integer price, String description, String image, UUID storeId) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
        ...
        category = Category.DESSERT.getType();
        subCategory = DessertType.COFFEE.getType();
    }
