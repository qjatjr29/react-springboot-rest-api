...
public class HalfChicken implements Food {
    ...
    public HalfChicken(UUID foodId, String name, Integer price, Category category, String description, String image) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
    ...
    public FoodDto toDto() {
        return new FoodDto(foodId, name, price, category.getType(),  description, "반반", image);
    }
