...
public class RiceStore implements Store {
    ...
    public RiceStore(UUID storeId, String name, String address, String phoneNumber, StoreCategory category, String image, LocalDate createdAt) {
