...
public class MeatHamburger implements Food {
    ...
    public MeatHamburger(UUID foodId, String name, Integer price, String description, String image, UUID storeId) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
        ...
        subCategory = HamburgerType.MEAT.getType();
    }
