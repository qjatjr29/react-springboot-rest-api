...
public class Jjambbong implements Food {
    ...
    public Jjambbong(UUID foodId, String name, Integer price, String description, String image, UUID storeId) {
        this.foodId = foodId;
        this.name = name;
        this.price = price;
        ...
        subCategory = NoodleType.JJAMBBONG.getType();
    }
